---
layout: post
title: "Logarithmic Depth Buffering in HLSL"
---

The [Project Reality Team][0] implemented logarithmic depth buffering for the 1.7.3 update. This post covers our implementation of simple logarithmic depth buffering in HLSL.

[Outerra has an optimized 2013 implementation of logarithmic depth in GLSL][1]. However, there’s not much public implementations of of logarithmic depth in HLSL.
...
VS2PS VS_LogDepth(APP2VS Input)
{
    ...
    Output.HPos = Input.Pos; // Usually a transformation happens here
    Output.Depth = Output.HPos.w + 1.0; // Output depth
